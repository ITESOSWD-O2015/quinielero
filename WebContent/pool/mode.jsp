...
<body onload="carga();">
	...
	<form action="ModeServlet" method="POST" onsubmit="return validate();">
		...
		<input type="radio" name="select_pool_mode_button" value="game"
			...
			id="select_league_button" required> Round mode <br> <input
			type="radio" name="select_pool_mode_button" value="league"
			id="select_league_button" required> League mode <br> <input
