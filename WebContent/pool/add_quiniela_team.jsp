...
<script
	src="bootstrap-master/docs/assets/js/bootstrap.min.js"
...
<title>Add team to your pool</title>
</head>
<body>
	<%@ page import="com.iteso.quinielero.teams.Team"%>
	<%@ page import="com.iteso.quinielero.pool.Pool"%>
