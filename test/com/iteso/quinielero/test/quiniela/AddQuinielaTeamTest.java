package com.iteso.quinielero.test.quiniela;
...
public class AddQuinielaTeamTest {
    ...
    public void testAddAllTeam(){
        ...
        assertEquals("Quiniela de tipo default con los equipos: Equipo 0 Equipo 1 Equipo 2 Equipo 3 Equipo 4 ", quiniela.toString());
    }
}
